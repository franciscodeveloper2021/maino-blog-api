...
- Apenas a API sem as views foi possível de ser deployada. Porém você pode visualizar os posts no browser pela rota `https://mysite-hojm.onrender.com` e trocar as páginas por exemplo: `https://mysite-hojm.onrender.com/?page=2`. Até então há 4 páginas com a paginação **requisitada no desafio** dos posts.
